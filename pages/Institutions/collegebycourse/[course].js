...
function Course({ courseData,course, query, currentPage, totalPages }) {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {totalPages > 1 && <Pagination totalPages={totalPages} pageName={`Institutions/collegebycourse/${course}`} currentPage={currentPage} />}
                </div>
            </section>
...
export async function getServerSideProps(context) {
    ...
    const { course } = params
    const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/get_colleges_by_course_name.php?course=${course}&slug=1&currentpage=${page}`)
